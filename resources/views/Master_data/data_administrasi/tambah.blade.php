               ...
               <div class="card">
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title">INPUT DATA ADMINISTRASI PENDAFTARAN SANGGAR TARI</h4>
                     </div>
                  </div>
                  <div class="card-body">
                     @if (count($errors) > 0)
                              ...
                              @endif
                     <form class="needs-validation" novalidate method="POST" action="{{ route('simpan_administrasi') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id_administrasi" value="{{ $kode_otomatis }}">
                        <div class="form-row">
                           ...
                           <div class="col-md-3 mb-3">
                              ...
                              <input type="date" class="form-control" id="validationCustom01"  required name="tgl_pembayaran">
                              <div class="valid-feedback">
                           ...
                           <div class="col-md-3 mb-3">
                              ...
                              <input type="text" class="form-control" id="bayar" onkeyup="sum()" required name="bayar" placeholder="Isi Bayar">
                              <div class="valid-feedback">
                                 Bayar Harus Di Isi
                              </div>
                           </div>
                           <div class="col-md-3 mb-3">
                              ...
                              <input type="text" class="form-control" id="tanggungan" onkeyup="sum()" required name="tanggungan" placeholder="Isi Tanggungan">
                              <div class="valid-feedback">
                           ...
                           <div class="col-md-2 mb-3">
                              ...
                              <label>
                                 <input type="radio" name="status_bayar" value="Lunas"> Lunas
                              </label>
                              <label>
                                 <input type="radio" name="status_bayar" value="Tidak Lunas"> Tidak Lunas
                              </label>
                              <div class="valid-feedback">
