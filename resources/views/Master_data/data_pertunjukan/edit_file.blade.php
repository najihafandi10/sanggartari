<div class="modal fade" role="dialog" aria-modal="true" id="new-project-modal{{ $tampil->id_pertunjukan }}">
        <div class="modal-dialog  modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header d-block text-center pb-3 border-bttom">
                    <h3 class="modal-title" id="exampleModalCenterTitle01">EDIT FOTO PERTUNJUKAN KELOMPOK TARI</h3>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <form method="POST" action="{{ route('aksi_edit_foto_pertunjukan') }}" enctype="multipart/form-data">
                            @csrf
