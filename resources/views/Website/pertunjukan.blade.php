                        ...
                        <div class="event-item rounded">
                            <div class="position-relative">
                                ...
                                <div class="d-flex justify-content-between border-start border-end bg-white px-2 py-2 w-100 position-absolute" style="bottom: 0; left: 0; opacity: 0.8;">
                                    ...
                                    <a href="#" class="text-dark"><span class="fas fa-map-marker-alt text-primary"></span> Asembagus</a>
                                </div>
                            </div>
                            <div class="border border-top-0 rounded-bottom p-4">
                                ...
                                <form method="get" action="{{ route('detail_pertunjukan') }}">
                                    <input type="hidden" name="cari" value="{{ $tampil->id_pertunjukan }}">
                                <button type="submit" class="btn btn-primary rounded-pill text-white py-2 px-4">Liat Pertunjukan</button>
                                </form>
                            </div>
                        </div>
                    </div>
